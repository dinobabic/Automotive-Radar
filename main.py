...
def main():
    ...
    visualize_radar_pcl(radar_dataset[6800])
    visualize_radar_pcl_aggregated_standard(radar_dataset, 6800, 0.5)
    ...
    #train_radar_detection_model(train_dataset_dir, device)
    visualize_radar_detection_model_results(train_dataset_dir, device, example_idx=6800, save_dir="./experiments/visualization_results")
